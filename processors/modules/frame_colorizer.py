...
from facefixer import config, content_analyser, inference_manager, logger, process_manager, state_manager, video_manager, wording
...
from facefixer.processors.types import FrameColorizerInputs
from facefixer.program_helper import find_argument_group
from facefixer.thread_helper import thread_semaphore
from facefixer.types import ApplyStateItem, Args, DownloadScope, ExecutionProvider, Face, InferencePool, ModelOptions, ModelSet, ProcessMode, QueuePayload, UpdateProgress, VisionFrame
from facefixer.vision import read_image, read_static_image, unpack_resolution, write_image
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		facefixer.jobs.job_store.register_step_keys([ 'frame_colorizer_model', 'frame_colorizer_blend', 'frame_colorizer_size' ])
