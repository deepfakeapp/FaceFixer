...
from facefixer.download import conditional_download_hashes, conditional_download_sources, resolve_download_url_by_provider
...
from facefixer.filesystem import get_file_name, in_directory, is_image, is_video, resolve_file_paths, resolve_relative_path, same_file_extension
from facefixer.processors import choices as processors_choices
from facefixer.processors.types import DeepSwapperInputs, DeepSwapperMorph
from facefixer.program_helper import find_argument_group
from facefixer.thread_helper import thread_semaphore
from facefixer.types import ApplyStateItem, Args, DownloadScope, Face, InferencePool, Mask, ModelOptions, ModelSet, ProcessMode, QueuePayload, UpdateProgress, VisionFrame
from facefixer.vision import conditional_match_frame_color, read_image, read_static_image, write_image
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		facefixer.jobs.job_store.register_step_keys([ 'deep_swapper_model', 'deep_swapper_morph' ])
