...
from facefixer import config, content_analyser, face_classifier, face_detector, face_landmarker, face_masker, face_recognizer, logger, process_manager, state_manager, video_manager, wording
from facefixer.face_analyser import get_many_faces, get_one_face
from facefixer.face_helper import warp_face_by_face_landmark_5
...
from facefixer.filesystem import in_directory, same_file_extension
from facefixer.processors import choices as processors_choices
from facefixer.processors.types import FaceDebuggerInputs
from facefixer.program_helper import find_argument_group
from facefixer.types import ApplyStateItem, Args, Face, InferencePool, ProcessMode, QueuePayload, UpdateProgress, VisionFrame
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		facefixer.jobs.job_store.register_step_keys([ 'face_debugger_items' ])
