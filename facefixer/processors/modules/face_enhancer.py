...
from facefixer.common_helper import create_float_metavar, create_int_metavar
...
from facefixer.processors.types import FaceEnhancerInputs, FaceEnhancerWeight
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		facefixer.jobs.job_store.register_step_keys([ 'face_enhancer_model', 'face_enhancer_blend', 'face_enhancer_weight' ])
