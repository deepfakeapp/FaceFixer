...
from facefixer.common_helper import create_int_metavar
from facefixer.download import conditional_download_hashes, conditional_download_sources, resolve_download_url
from facefixer.face_analyser import get_many_faces, get_one_face
from facefixer.face_helper import paste_back, warp_face_by_face_landmark_5
from facefixer.face_masker import create_box_mask, create_occlusion_mask
from facefixer.face_selector import find_similar_faces, sort_and_filter_faces
from facefixer.face_store import get_reference_faces
from facefixer.filesystem import in_directory, is_image, is_video, resolve_relative_path, same_file_extension
from facefixer.processors import choices as processors_choices
from facefixer.processors.live_portrait import create_rotation, limit_expression
from facefixer.processors.types import ExpressionRestorerInputs, LivePortraitExpression, LivePortraitFeatureVolume, LivePortraitMotionPoints, LivePortraitPitch, LivePortraitRoll, LivePortraitScale, LivePortraitTranslation, LivePortraitYaw
from facefixer.program_helper import find_argument_group
from facefixer.thread_helper import conditional_thread_semaphore, thread_semaphore
from facefixer.types import ApplyStateItem, Args, DownloadScope, Face, InferencePool, ModelOptions, ModelSet, ProcessMode, QueuePayload, UpdateProgress, VisionFrame
from facefixer.vision import read_image, read_static_image, read_video_frame, write_image
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		facefixer.jobs.job_store.register_step_keys([ 'expression_restorer_model', 'expression_restorer_factor' ])
