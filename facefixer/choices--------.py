...
download_provider_set : DownloadProviderSet =\
{
	'github':
	{
		...
		'path': '/deepfakeapp/facefixer-assets/releases/download/{base_name}/{file_name}'
	},
	'huggingface':
	{
		'urls':
		...
		'path': '/facefixer/{base_name}/resolve/main/{file_name}'
	}
}
