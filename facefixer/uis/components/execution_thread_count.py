...
def render() -> None:
	...
	EXECUTION_THREAD_COUNT_SLIDER = gradio.Slider(
		...
		step = calc_int_step(facefixer.choices.execution_thread_count_range),
		minimum = facefixer.choices.execution_thread_count_range[0],
		maximum = facefixer.choices.execution_thread_count_range[-1]
	)
