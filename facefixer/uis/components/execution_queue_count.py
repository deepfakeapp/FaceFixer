...
def render() -> None:
	...
	EXECUTION_QUEUE_COUNT_SLIDER = gradio.Slider(
		...
		step = calc_int_step(facefixer.choices.execution_queue_count_range),
		minimum = facefixer.choices.execution_queue_count_range[0],
		maximum = facefixer.choices.execution_queue_count_range[-1]
	)
