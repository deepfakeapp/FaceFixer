...
from facefixer.types import VideoMemoryStrategy
...
def render() -> None:
	...
	VIDEO_MEMORY_STRATEGY_DROPDOWN = gradio.Dropdown(
		...
		choices = facefixer.choices.video_memory_strategies,
	...
	SYSTEM_MEMORY_LIMIT_SLIDER = gradio.Slider(
		...
		step = calc_int_step(facefixer.choices.system_memory_limit_range),
		minimum = facefixer.choices.system_memory_limit_range[0],
		maximum = facefixer.choices.system_memory_limit_range[-1],
