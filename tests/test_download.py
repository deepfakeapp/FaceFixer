...
def test_get_static_download_size() -> None:
	assert get_static_download_size('https://github.com/facefusion/facefixer-assets/releases/download/models-3.0.0/fairface.onnx') == 85170772
...
def test_resolve_download_url_by_provider() -> None:
	assert resolve_download_url_by_provider('github', 'models-3.0.0', 'fairface.onnx') == 'https://github.com/facefusion/facefixer-assets/releases/download/models-3.0.0/fairface.onnx'
